...
def get_model_configurations():
    ...
    image_size = [(128, 128), (256, 256), (512, 512)]  # Different image sizes
            ...
            for batch_size in batch_size_options:
                for img_size in image_size:
                    ...
                    config.update({
                        ...
                        'img_size': img_size,  # <-- Korrekt variabel!
...
def main():
    ...
    save_dir = f"experiments/focal_alpha_025_gamma_2_with_img"  # Updated name
    ...
    try:
        ...
        print("⚠️  Failed to generate comparison plots. Skipping this step.")
...
def plot_model_config_results(cv_summary, generalization_results, data_split, save_dir):
    ...
    table = plt.table(
        cellText=table_data,
        colLabels=['Backbone', 'Attention', 'BS', 'ImgSize', 'CV IoU', 'Test IoU'],
        cellLoc='center',
        loc='center'
    )
